  ...
  playTransition(callback, targetPath) {
    ...
    if (!prefersReducedMotion && _gsapLoaded && window.gsap) {
      ...
      portalStyleEl.textContent = [
        ...
        '.ss-portal-css__inner::before{content:"";animation-direction:reverse;background:linear-gradient(#30102a -25%,transparent 50%,#8a45aa 125%),var(--ss-portal-color,#8845a8)}',
      ].join("");
