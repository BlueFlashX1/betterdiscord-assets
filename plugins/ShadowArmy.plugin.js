...
// Hand-drawn ARISE SVG (from Arisefont.svg) — purple fill, used in ARISE extraction animation
    ...
    try {
      if (typeof ARISE_SVG === 'string' && ARISE_SVG.length > 100) {
        ...
        if (!svgDoc.querySelector('parsererror')) {
          ...
          svgEl.style.cssText = 'height: 180px !important; width: auto !important; display: inline-block !important; filter: drop-shadow(0 0 24px #8b5cf6) drop-shadow(0 0 60px rgba(139, 92, 246, 0.4)) !important;';
          title.style.cssText = 'text-align: center !important; display: flex !important; justify-content: center !important; align-items: center !important;';
