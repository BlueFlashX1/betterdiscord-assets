...
async function flushToDisk() {
  // Guard against re-entrancy: if a flush is already in flight, bail out.
  // The next interval tick will pick up any guilds that were dirtied in the meantime.
  ...
  try {
    ...
    // Yield to the event loop between each save so keystrokes are not blocked.
