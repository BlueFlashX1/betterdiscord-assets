module.exports = {
  ...
  calculateDamageBreakdown(attackerStats, defenderStats, attackerRank, defenderRank) {
    ...
    // Equipment flat attack bonus (applies only to player, not shadows)
    ...
    // Equipment flat defense bonus (applies only to player defending)
      ...
      stats = {
        strength:
          (baseStats.strength || 0) +
            ...
            (naturalGrowthStats.strength || 0) || (stats.strength || 0),
        agility:
          (baseStats.agility || 0) +
            (growthStats.agility || 0) +
            (naturalGrowthStats.agility || 0) || (stats.agility || 0),
        intelligence:
          (baseStats.intelligence || 0) +
            (growthStats.intelligence || 0) +
            (naturalGrowthStats.intelligence || 0) || (stats.intelligence || 0),
        vitality:
          (baseStats.vitality || 0) +
            (growthStats.vitality || 0) +
            (naturalGrowthStats.vitality || 0) || (stats.vitality || 0),
        perception:
          (baseStats.perception || 0) +
            (growthStats.perception || 0) +
            (naturalGrowthStats.perception || 0) || (stats.perception || 0),
      };
    }
