...
module.exports = {
  async start() {
    ...
    // Guard: unregister any handler left over from a previous start() before re-assigning.
    // This prevents handler stacking on rapid restart or when stop() ran before this line.
    if (this._pluginToggleHandler && typeof BdApi?.Events?.off === 'function') {
