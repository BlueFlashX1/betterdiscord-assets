module.exports = {
  startActivityTracking() {
    ...
    // Seed lastActiveTime on cold restart so the first interval tick doesn't
    // see (now - null) = now, which exceeds the 5-minute guard and silently
    // skips accumulation until the first mouse/keyboard event.
